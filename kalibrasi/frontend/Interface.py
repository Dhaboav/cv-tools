...
class ChoiceDialog:
    ...
    def popup_component(self, GUI):
        ...
        info.pack(pady=5)
        choices = ['Test Hasil Kalibrasi', 'Kalibrasi real time', 'Kalibrasi gambar']

        # button setting
        button_frame = Frame(GUI)
        button_frame.pack()
        for choice in choices:
            button = Button(button_frame, text=choice, width=20, bg='black', fg='white',command=lambda c=choice: self.button_click(c))
